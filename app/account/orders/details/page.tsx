...
import { ArrowLeft, Package, Truck, CheckCircle, FileText, Download, HelpCircle, Clock } from "lucide-react"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 md:py-12">
        ...
        <div className="bg-[#faf5eb] rounded-lg p-6 mb-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              <h1 className="text-2xl font-medium mb-1">Order #{orderDetails.id}</h1>
              <p className="text-gray-600">Placed on {orderDetails.date}</p>
            </div>
            <div className={`px-4 py-2 rounded-full ${getStatusColor(orderDetails.status)} font-medium text-sm`}>
              {orderDetails.status}
            </div>
          </div>
        </div>
                  ...
                  <div className="md:hidden grid grid-cols-[80px,1fr] gap-4">
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <div className="font-medium text-[#a08452]">₹{(item.price * item.quantity).toFixed(2)}</div>
                      </div>
                    </div>
                  </div>
          ...
          <div className="lg:col-span-1">
              ...
              <div className="p-6">
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between pt-4 border-t font-medium">
                    <span>Total</span>
                    <span className="text-lg text-[#a08452]">₹{orderDetails.payment.total.toFixed(2)}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg border shadow-sm overflow-hidden mb-8">
              ...
              <div className="p-6">
                ...
                <div className="mb-4">
                  <h3 className="text-sm font-medium text-gray-600 mb-1">Shipping Method</h3>
                ...
                <div>
                  ...
                  <p className="text-[#a08452] font-medium">{orderDetails.shipping.tracking}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg border shadow-sm overflow-hidden">
              ...
              <div className="p-6">
                ...
                <div className="mb-4">
                  <h3 className="text-sm font-medium text-gray-600 mb-1">Billing Address</h3>
                  <p className="text-gray-800">{orderDetails.shipping.address}</p>
                </div>
              </div>
            </div>
