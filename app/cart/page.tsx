      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 md:py-12">
        ...
        {cartItems.length === 0 ? (
          <div className="text-center py-16">
            ...
            <Link href="/shop">
              <Button className="bg-[#a08452] hover:bg-[#8c703d] py-2 h-auto">Continue Shopping</Button>
            </Link>
          </div>
        ) : (
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex-1 overflow-x-auto">
              ...
              <div className="hidden md:grid md:grid-cols-[3fr,1fr,1fr,1fr] border-b pb-4 mb-4">
